  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.headerText}>Tameer e nau Public College</Text>
      ...
      <View style={styles.navigationSection}>
        <TouchableOpacity style={styles.navigationItem} onPress={() => navigation.navigate("Frame")}>
          <Image
...
export default TabNavigatorScreen1;
