...
const ScienceClgScreen = ({ navigation }) => {
  ...
  const handleConfirmation = async () => {
    try {
      ...
      if (imageUri) {
        ...
        const imageRef = ref(storage, `documents/ScienceClg/${currentUser.uid}/${imageName}`);
        await uploadBytes(imageRef, blob);
        imageUrl = await getDownloadURL(imageRef);
      }
  
      await addDoc(collection(db, 'ScienceClgStudentsInfo'), {
...
export default ScienceClgScreen;
