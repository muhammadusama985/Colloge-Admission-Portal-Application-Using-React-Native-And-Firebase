...
const TechnicalBoysClg = ({ navigation }) => {
  ...
  const handleConfirmation = async () => {
    try {
      ...
      if (imageUri) {
        ...
        const imageRef = ref(storage, `documents/TechnicalBoysClg/${currentUser.uid}/${imageName}`);
        await uploadBytes(imageRef, blob);
        imageUrl = await getDownloadURL(imageRef);
      }
  
      await addDoc(collection(db, 'TechnicalBoysClgStudentsInfo'), {
...
export default TechnicalBoysClg;
