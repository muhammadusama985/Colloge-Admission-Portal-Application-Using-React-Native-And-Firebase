    ...
    <View style={styles.container}>
      <ScrollView>
        <View style={styles.header}>
          ...
          />
          <Text style={styles.collegeName}>Tameer E Nau Public College</Text>
        </View>
          ...
          {isEditing ? (
            ...
            <>
              <Text style={styles.aboutText}>
                Tameer-i-Nau Public College is an educational institution in Balochistan, Pakistan. It was established in July 1984 with the motto "Wisdom is the base of my deen (religion) and knowledge is my power".
              </Text>
