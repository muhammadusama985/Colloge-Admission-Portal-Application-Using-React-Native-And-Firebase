...
const IslamiaGirlsClg = ({ navigation }) => {
...
const handleConfirmation = async () => {
  try {
    ...
    if (imageUri) {
      ...
      const imageRef = ref(storage, `documents/IslamiGirlsClg/${currentUser.uid}/${imageName}`);
      await uploadBytes(imageRef, blob);
      imageUrl = await getDownloadURL(imageRef);
    }

    await addDoc(collection(db, 'IslamiaGirlsClgStudentsInfo'), {
...
export default IslamiaGirlsClg;
