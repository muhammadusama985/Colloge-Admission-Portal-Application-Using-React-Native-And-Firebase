...
const ScienceClgMeritListsScreen = () => {
  ...
  useEffect(() => {
    const fetchMeritLists = async () => {
      try {
        const storageRef = ref(storage, 'ScienceClgMeritLists');
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>Science College Merit Lists</Text>
      <FlatList
        data={meritLists}
...
export default ScienceClgMeritListsScreen;
