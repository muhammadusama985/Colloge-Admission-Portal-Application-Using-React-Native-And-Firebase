...
const CantGirlsDegreeClg = ({ navigation }) => {
  ...
  const handleConfirmation = async () => {
    try {
      ...
      if (imageUri) {
        ...
        const imageRef = ref(storage, `documents/CantGirlsDegreeClg/${currentUser.uid}/${imageName}`);
        await uploadBytes(imageRef, blob);
        imageUrl = await getDownloadURL(imageRef);
      }
  
      await addDoc(collection(db, 'CantGirlsDegreeClgStudentsInfo'), {
...
export default CantGirlsDegreeClg;
