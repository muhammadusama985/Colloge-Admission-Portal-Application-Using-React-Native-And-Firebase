...
const CollegeSettings = ({ navigation }) => {
  ...
  return (
    <ScrollView style={[styles.container, darkMode && styles.darkContainer]}>
      <View style={styles.blockContainer}>
        <TouchableOpacity style={styles.block} onPress={() => navigation.navigate('CollegeMeritLists')}>
          <Ionicons name="person-circle-outline" size={50} color={darkMode ? "#FFF" : "#003F6C"} />
          <Text style={[styles.blockText, darkMode && styles.darkText]}>College Merit Lists</Text>
        </TouchableOpacity>
